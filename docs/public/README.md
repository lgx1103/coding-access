...
| 下载 | 版本 | 安装方式 |
|---|---|---|
| [服务端](https://github.com/lgx1103/coding-access/releases/tag/server-v0.1.23) | 0.1.23 | Linux + Docker Compose，见[部署文档](deployment.md) |
...
服务端与客户端独立更新。其他版本、更新包及安装提示见 [Releases](https://github.com/lgx1103/coding-access/releases)，备份和升级步骤见[部署文档](deployment.md)。
...
- [客户端构建与更新签名](releases.md)
- [协议兼容与测试](verification.md)
- [安全问题反馈](../../SECURITY.md)
